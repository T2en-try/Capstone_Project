...
export default function VerificationDetailDrawer({
  ...
  const priorityConfig = getPriorityConfig(report.priorityClass);
  ...
  return (
    ...
    >
      ...
      <Section
        ...
        subtitle="Original image and AI-analyzed image"
      >
        <Row gutter={[14, 14]}>
          <Col xs={24} md={12}>
            <Text
      ...
      <Section
        icon={<RobotOutlined />}
        title="AI Analysis"
        subtitle="Confidence and probability for each priority level"
      >
        <Row gutter={[20, 18]}>
          <Col xs={24} md={10}>
            <div
      ...
      <Section
        ...
        subtitle="Supporting data from spatial analysis"
      >
        <Row gutter={[12, 12]}>
          <Col xs={24} sm={8}>
            <div
